...
int main(int count, char *arguments[])
{
    ...
    Board board(
        "zpweaqfsxlasleunpnoanslseavlvalujdihfsxlasleubdhazpweaqfs"
        "xlasleunpnoanslseavlvalujdihfsxlasleubdhaue",
        10, 10);

    Dictionary dictionary(arguments[1], [&](std::string const &string) {
        for (auto i : string) {
