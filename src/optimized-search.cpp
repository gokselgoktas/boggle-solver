...
namespace boggle {
        OptimizedSearch::Results const &
                OptimizedSearch::operator ()(Board const &board,
                        Dictionary const &dictionary)
        {
                ...
                for (auto const &i : dictionary.getRootNode()->getSubnodes()) {
                        ...
                        for (auto const &k : positions) {
                                std::string string;
                                search(board, k.first, k.second, i.first,
                                        i.second, string);
                        }
                }
        ...
        void OptimizedSearch::search(Board const &board, unsigned x,
                unsigned y, char letter,
